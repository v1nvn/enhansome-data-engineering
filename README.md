# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 461,713 | 🐛 70 | 📅 2026-04-19 with stars
...
* Relational
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,467 | 🐛 73 | 🌐 Go | 📅 2026-05-02 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,485 | 🐛 2,138 | 🌐 Rust | 📅 2026-05-01 - Scalable datastore for metrics, events, and real-time analytics.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,512 | 🐛 3,608 | 🌐 C++ | 📅 2026-05-02 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 971 | 🐛 567 | 🌐 C | 📅 2026-04-30 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 282 | 🐛 293 | 🌐 Java | 📅 2026-05-02 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 8,195 | 🐛 19 | 🌐 Rust | 📅 2026-05-03 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,534 | 🐛 162 | 🌐 Go | 📅 2026-04-30 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,181 | 🐛 274 | 🌐 C++ | 📅 2026-05-03 - Protocol Buffers - Google's data interchange format.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 63,359 | 🐛 35 | 🌐 Python | 📅 2026-05-03 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 7,563 | 🐛 47 | 🌐 Python | 📅 2026-05-03 - An open source ETL framework to build fresh index for AI.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 72,673 | 🐛 1,233 | 🌐 TypeScript | 📅 2026-05-03 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 47,178 | 🐛 4,105 | 🌐 Clojure | 📅 2026-05-03 - The easy, open source way for everyone in your company to ask questions and learn from data.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 45,263 | 🐛 1,725 | 🌐 Python | 📅 2026-05-03 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,773 | 🐛 502 | 🌐 Java | 📅 2026-05-01 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,711 | 🐛 162 | 🌐 Python | 📅 2026-04-10 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,425 | 🐛 2,648 | 🌐 Python | 📅 2026-05-02 - An open-source Python library for building data applications.
...
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,468 | 🐛 152 | 🌐 Jupyter Notebook | 📅 2026-05-03 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,566 | 🐛 30 | 🌐 Go | 📅 2026-05-01 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,945 | 🐛 894 | 🌐 Java | 📅 2026-05-01 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
...
* [FirstData](https://github.com/MLT-OSS/FirstData) ⭐ 157 | 🐛 1 | 🌐 Python | 📅 2026-05-02 - The world's most comprehensive authoritative data source knowledge base. 160+ curated sources from governments, international organizations, and research institutions with MCP integration.

## Monitoring

### Prometheus

* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 63,873 | 🐛 767 | 🌐 Go | 📅 2026-04-29 - An open-source service monitoring system and time series database.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 476 | 🐛 95 | 🌐 C++ | 📅 2026-05-02 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.

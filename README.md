# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 472,460 | 🐛 81 | 📅 2026-06-02 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 40,126 | 🐛 6,283 | 🌐 Go | 📅 2026-06-03 - A distributed NewSQL database compatible with MySQL protocol.
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,561 | 🐛 71 | 🌐 Go | 📅 2026-06-02 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,522 | 🐛 2,145 | 🌐 Rust | 📅 2026-06-02 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 14,016 | 🐛 831 | 🌐 Java | 📅 2026-06-02 - Column oriented distributed data store ideal for powering interactive applications.
  * [OpenTSDB](https://github.com/OpenTSDB/opentsdb) ⭐ 5,069 | 🐛 537 | 🌐 Java | 📅 2024-12-12 - A scalable, distributed Time Series Database.
  * [kairosdb](https://github.com/kairosdb/kairosdb) ⭐ 1,760 | 🐛 141 | 🌐 Java | 📅 2026-03-05 - Fast scalable time series database.
  ...
  * [Timely](https://github.com/NationalSecurityAgency/timely) ⭐ 391 | 🐛 20 | 🌐 Java | 📅 2026-05-13 - A time series database application that provides secure access to time series data based on Accumulo and Grafana.
...
* Other
  * [cayley](https://github.com/cayleygraph/cayley) ⭐ 15,044 | 🐛 92 | 🌐 Go | 📅 2026-05-05 - An open-source graph database. Google.
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,639 | 🐛 1,652 | 🌐 Lua | 📅 2026-06-02 - An in-memory database and application server.
  * [Snappydata](https://github.com/SnappyDataInc/snappydata) ⭐ 1,034 | 🐛 117 | 🌐 Scala | 📅 2022-11-21 - OLTP + OLAP Database built on Apache Spark.
  * [SlothDB](https://github.com/SouravRoy-ETL/slothdb) ⭐ 757 | 🐛 5 | 🌐 C++ | 📅 2026-05-22 - In-process analytical SQL database written in C++20. Reads Parquet, CSV, JSON, Avro, Arrow, SQLite, and Excel directly. Single binary, Python package, and 1.3 MB WASM build for the browser.
...
* Graph
  ...
  * [Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 280 | 🐛 11 | 🌐 Rust | 📅 2026-06-02 - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
  * [Actionbase](https://github.com/kakao/actionbase) ⭐ 217 | 🐛 28 | 🌐 Kotlin | 📅 2026-06-02 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,574 | 🐛 3,589 | 🌐 C++ | 📅 2026-06-03 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
    * [CCM](https://github.com/pcmanus/ccm) ⭐ 1,232 | 🐛 73 | 🌐 Python | 📅 2026-04-21 - A script to easily create and destroy an Apache Cassandra cluster on localhost.
  ...
  * [FiloDB](https://github.com/filodb/FiloDB) ⭐ 1,463 | 🐛 68 | 🌐 Scala | 📅 2026-06-02 - Distributed. Columnar. Versioned. Streaming. SQL.
...
* [datacompy](https://github.com/capitalone/datacompy) ⭐ 647 | 🐛 6 | 🌐 Python | 📅 2026-06-01 - A Python library that facilitates the comparison of two DataFrames in Pandas, Polars, Spark and more. The library goes beyond basic equality checks by providing detailed insights into discrepancies at both row and column levels.
* [dvt](https://github.com/GoogleCloudPlatform/professional-services-data-validator) ⭐ 511 | 🐛 153 | 🌐 Python | 📅 2026-06-02 - Data Validation Tool compares data from source and target tables to ensure that they match. It provides column validation, row validation, schema validation, custom query validation, and ad hoc SQL exploration.
* [everyrow](https://github.com/futuresearch/everyrow-sdk) ⭐ 41 | 🐛 3 | 🌐 Python | 📅 2026-06-01 - AI-powered data operations SDK for Python. Semantic deduplication, fuzzy table merging, and intelligent row ranking using LLM agents.
* [koala-diff](https://github.com/godalida/koala-diff) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-02-25 - A high-performance Python library for comparing large datasets (CSV, Parquet) locally using Rust and Polars. It features zero-copy streaming to prevent OOM errors and generates interactive HTML data quality reports.

## Data Ingestion

* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  * [kafka-manager](https://github.com/yahoo/kafka-manager) ⭐ 11,929 | 🐛 520 | 🌐 Scala | 📅 2023-08-02 - A tool for managing Apache Kafka.
  * [kafka-docker](https://github.com/wurstmeister/kafka-docker) ⭐ 6,970 | 🐛 126 | 🌐 Shell | 📅 2024-05-08 - Kafka in Docker.
  * [kafkacat](https://github.com/edenhill/kafkacat) ⭐ 5,763 | 🐛 161 | 🌐 C | 📅 2024-07-09 - Generic command line non-JVM Apache Kafka producer and consumer.
  * [kafka-node](https://github.com/SOHU-Co/kafka-node) ⭐ 2,653 | 🐛 446 | 🌐 JavaScript | 📅 2023-08-30 - Node.js client for Apache Kafka 0.8.
  * [Secor](https://github.com/pinterest/secor) ⭐ 1,859 | 🐛 269 | 🌐 Java | 📅 2026-03-10 - Pinterest's Kafka to S3 distributed consumer.
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 978 | 🐛 575 | 🌐 C | 📅 2026-06-03 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 285 | 🐛 286 | 🌐 Java | 📅 2026-06-03 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 8,432 | 🐛 16 | 🌐 Rust | 📅 2026-06-03 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,111 | 🐛 56 | 🌐 Python | 📅 2026-05-30 - Utility belt to handle data on AWS.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,587 | 🐛 19 | 🌐 Go | 📅 2026-06-03 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
* [Heka](https://github.com/mozilla-services/heka) ⚠️ Archived - Data Acquisition and Processing Made Easy. Deprecated.
* [Gobblin](https://github.com/apache/incubator-gobblin) ⭐ 2,265 | 🐛 139 | 🌐 Java | 📅 2026-06-01 - Universal data ingestion framework for Hadoop from LinkedIn.
* [pdfmux](https://github.com/NameetP/pdfmux) ⭐ 66 | 🐛 3 | 🌐 Python | 📅 2026-05-22 - Python PDF-to-Markdown orchestrator. Classifies each page and routes to the optimal backend (PyMuPDF, Docling, RapidOCR, Gemini Flash), emitting Markdown plus a per-page confidence score so ingestion pipelines can quarantine low-trust pages before feeding LLMs or retrieval.
* [drt](https://github.com/drt-hub/drt) ⭐ 27 | 🐛 67 | 🌐 Python | 📅 2026-06-01 - OSS Reverse ETL CLI. Sync data from warehouses to business tools via YAML.
...
* [crdt-merge](https://github.com/mgillr/crdt-merge) ⭐ 3 | 🐛 4 | 🌐 Python | 📅 2026-05-02 - Conflict-free merge for DataFrames, JSON, ML models & distributed agents — powered by CRDTs.
...
* [CARQ](https://github.com/whispering3/CARQ) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-05-31 - Context-Aware RAG Processing Queue for high availability and adaptive rate-limiting.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,654 | 🐛 164 | 🌐 Go | 📅 2026-06-03 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
* [AWS S3](https://aws.amazon.com/s3/) - Object storage built to retrieve any amount of data from anywhere.
  * [smart\_open](https://github.com/RaRe-Technologies/smart_open) ⭐ 3,448 | 🐛 17 | 🌐 Python | 📅 2026-05-29 - Utils for streaming large files (S3, HDFS, gzip, bz2).
* [S3QL](https://github.com/s3ql/s3ql/) ⭐ 1,248 | 🐛 14 | 🌐 Python | 📅 2026-05-31 - A file system that stores all its data online using storage services like Google Storage, Amazon S3, or OpenStack.
...
* [SeaweedFS](https://github.com/chrislusf/seaweedfs) ⭐ 24 | 🐛 0 | 🌐 Go | 📅 2026-06-02 - Seaweed-FS is a simple and highly scalable distributed file system. There are two objectives: to store billions of files! to serve the files fast! Instead of supporting full POSIX file system semantics, Seaweed-FS choose to implement only a key\~file mapping. Similar to the word "NoSQL", you can call it as "NoFS".
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,307 | 🐛 304 | 🌐 C++ | 📅 2026-06-03 - Protocol Buffers - Google's data interchange format.
* [Apache Parquet](https://parquet.apache.org) - A columnar storage format available to any project in the Hadoop ecosystem, regardless of the choice of data processing framework, data model or programming language.
  * [Snappy](https://github.com/google/snappy) ⭐ 6,577 | 🐛 58 | 🌐 C++ | 📅 2026-05-09 - A fast compressor/decompressor. Used with Parquet.
  * [PigZ](https://zlib.net/pigz/) - A parallel implementation of gzip for modern multi-processor, multi-core machines.
* [Kryo](https://github.com/EsotericSoftware/kryo) ⭐ 6,529 | 🐛 38 | 🌐 HTML | 📅 2026-06-02 - A fast and efficient object graph serialization framework for Java.
* [AKF](https://github.com/HMAKT99/AKF) ⭐ 6 | 🐛 12 | 🌐 Python | 📅 2026-05-25 - The AI native file format. Trust scores, source provenance, and compliance metadata that embed into 20+ formats (DOCX, PDF, images, code). EXIF for AI.
* [PFC-JSONL](https://github.com/ImpossibleForge/pfc-jsonl) ⭐ 5 | 🐛 0 | 📅 2026-05-21 - Specialized JSONL log compressor with block-level timestamp indexing and DuckDB integration. Achieves \~9% compression ratio (better than gzip) with time-range random access queries.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 63,125 | 🐛 38 | 🌐 Python | 📅 2026-06-03 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 10,159 | 🐛 66 | 🌐 Python | 📅 2026-06-03 - An open source ETL framework to build fresh index for AI.
* [PipelineDB](https://github.com/pipelinedb/pipelinedb) ⭐ 2,662 | 🐛 133 | 🌐 C | 📅 2022-02-20 - The Streaming SQL Database.
* [Robinhood's Faust](https://github.com/faust-streaming/faust) ⭐ 1,875 | 🐛 147 | 🌐 Python | 📅 2026-03-30 - Forever scalable event processing & in-memory durable K/V store as a library with asyncio & static typing.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,706 | 🐛 43 | 🌐 Go | 📅 2026-06-03 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 690 | 🐛 208 | 🌐 Java | 📅 2026-06-03 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* Batch SQL
  * [Hive](https://hive.apache.org) - Data warehouse software facilitates querying and managing large datasets residing in distributed storage.
    * [PyHive](https://github.com/dropbox/PyHive) ⭐ 1,697 | 🐛 223 | 🌐 Python | 📅 2026-04-13 - Python interface to Hive and Presto.
...
* [Substation](https://github.com/brexhq/substation) ⭐ 401 | 🐛 2 | 🌐 Go | 📅 2026-01-20 - A cloud native data pipeline and transformation toolkit written in Go.
...
* [dna-claude-analysis](https://github.com/shmlkv/dna-claude-analysis) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-03-04 - Personal genome analysis toolkit with Python scripts analyzing raw DNA data across 17 categories (health risks, ancestry, pharmacogenomics, nutrition, psychology, etc.) and generating a terminal-style single-page HTML visualization.
* Batch ML
  * [Datatrax](https://github.com/rbmuller/datatrax) ⭐ 9 | 🐛 13 | 🌐 Go | 📅 2026-05-01 - Pure-Go classic machine learning toolkit and data engineering utilities. Eight algorithms with zero external dependencies.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 73,138 | 🐛 1,257 | 🌐 TypeScript | 📅 2026-06-03 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 47,539 | 🐛 4,189 | 🌐 Clojure | 📅 2026-06-03 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,228 | 🐛 544 | 🌐 Python | 📅 2026-06-03 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
* [PyXley](https://github.com/stitchfix/pyxley) ⭐ 2,267 | 🐛 28 | 🌐 JavaScript | 📅 2025-06-02 - Python helpers for building dashboards using Flask and React.
* [QueryGPT](https://github.com/MKY508/QueryGPT) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - Natural language database query interface with automatic chart generation, supporting Chinese and English queries.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 45,677 | 🐛 1,701 | 🌐 Python | 📅 2026-06-03 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,947 | 🐛 504 | 🌐 Java | 📅 2026-06-03 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,734 | 🐛 158 | 🌐 Python | 📅 2026-05-19 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,619 | 🐛 2,661 | 🌐 Python | 📅 2026-06-02 - An open-source Python library for building data applications.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,438 | 🐛 43 | 🌐 Go | 📅 2026-06-03 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,505 | 🐛 147 | 🌐 Jupyter Notebook | 📅 2026-06-01 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,660 | 🐛 133 | 🌐 Ruby | 📅 2026-06-03 - The open-source reverse ETL, data activation platform for modern data teams.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,611 | 🐛 28 | 🌐 Go | 📅 2026-06-03 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [PACE](https://github.com/getstrm/pace) ⭐ 39 | 🐛 16 | 🌐 Kotlin | 📅 2026-06-02 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
* [Dotflow](https://github.com/dotflow-io/dotflow) ⭐ 7 | 🐛 37 | 🌐 Python | 📅 2026-05-03 - A lightweight Python library for building execution pipelines with retry, parallel execution, cron scheduling, and async support.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,390 | 🐛 435 | 🌐 Go | 📅 2026-06-01 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,992 | 🐛 877 | 🌐 Java | 📅 2026-06-03 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,462 | 🐛 163 | 🌐 Java | 📅 2026-06-03 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [elasticsearch-jdbc](https://github.com/jprante/elasticsearch-jdbc) ⭐ 2,818 | 🐛 416 | 🌐 Java | 📅 2021-11-05 - JDBC importer for Elasticsearch.
* [docker-logstash](https://github.com/pblittle/docker-logstash) ⭐ 238 | 🐛 0 | 🌐 Shell | 📅 2015-12-21 - A highly configurable Logstash (1.4.4) - Docker image running Elasticsearch (1.7.0) - and Kibana (3.1.2).

## Docker

* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,173 | 🐛 64 | 🌐 Go | 📅 2026-06-02 - Analyzes resource usage and performance characteristics of running containers.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,538 | 🐛 1,646 | 🌐 Go | 📅 2026-06-03 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
* [Weave](https://github.com/weaveworks/weave) ⚠️ Archived - Weaving Docker containers into applications.
* [Flocker](https://github.com/ClusterHQ/flocker) ⭐ 3,382 | 🐛 80 | 🌐 Python | 📅 2017-05-18 - Easily manage Docker containers & their data.
...
* [Eventsim](https://github.com/Interana/eventsim) ⭐ 542 | 🐛 5 | 🌐 Scala | 📅 2026-01-27 - Event data simulator. Generates a stream of pseudo-random events from a set of users, designed to simulate web traffic.
* [Helium MCP](https://github.com/connerlambden/helium-mcp) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-27 - Remote MCP server for real-time financial data, 3.2M+ news articles, ML options pricing, and news bias analysis. Free, no API key. [MCP](https://heliumtrades.com/mcp)
...
* [FirstData](https://github.com/MLT-OSS/FirstData) ⭐ 164 | 🐛 0 | 🌐 Python | 📅 2026-05-13 - The world's most comprehensive authoritative data source knowledge base. 160+ curated sources from governments, international organizations, and research institutions with MCP integration.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 64,253 | 🐛 804 | 🌐 Go | 📅 2026-06-02 - An open-source service monitoring system and time series database.
...
* [Signals CLI](https://github.com/sortlist/signals-cli) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-09 - Intent signal monitoring CLI. Track LinkedIn engagers, keyword posters, job changers, funding events. JSON output for data pipelines.

## Profiling

### Data Profiler

* [Data Profiler](https://github.com/capitalone/dataprofiler) ⭐ 1,556 | 🐛 81 | 🌐 Python | 📅 2026-05-06 - The DataProfiler is a Python library designed to make data analysis, monitoring, and sensitive data detection easy.
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 481 | 🐛 92 | 🌐 C++ | 📅 2026-06-01 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
...
* [Grai](https://github.com/grai-io/grai-core/) ⭐ 314 | 🐛 51 | 🌐 Python | 📅 2026-01-30 - A data catalog tool that integrates into your CI system exposing downstream impact testing of data changes. These tests prevent data changes which might break data pipelines or BI dashboards from making it to production.
* [DQOps](https://github.com/dqops/dqo) ⭐ 193 | 🐛 5 | 🌐 Java | 📅 2026-01-05 - An open-source data quality platform for the whole data platform lifecycle from profiling new data sources to applying full automation of data quality monitoring.
* [daffy](https://github.com/vertti/daffy/) ⭐ 58 | 🐛 1 | 🌐 Python | 📅 2026-06-03 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.
* [Snowflake Emulator](https://github.com/nnnkkk7/snowflake-emulator) ⭐ 37 | 🐛 7 | 🌐 Go | 📅 2026-01-19 - A Snowflake-compatible emulator for local development and testing.
* [Provero](https://github.com/provero-org/provero) ⭐ 15 | 🐛 10 | 🌐 Python | 📅 2026-06-01 - A vendor-neutral, declarative data quality engine. Define checks in YAML, run anywhere. Includes 16 built-in check types, SQL batch optimizer, anomaly detection, and data contracts.
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 5 | 🐛 9 | 🌐 Python | 📅 2026-06-01 - Zero-config data quality CLI. Profiles every table on first run, then auto-detects anomalies (volume drops, schema drift, freshness misses, distribution shifts) on subsequent runs. No YAML, no rules to write. Works with Postgres, BigQuery, Snowflake, and dbt.
* [Aegis DQ](https://github.com/aegis-dq/aegis-dq) ⭐ 3 | 🐛 9 | 🌐 Python | 📅 2026-05-27 - Open-source agentic data quality framework with LLM-powered diagnosis, root-cause analysis, SQL auto-fix proposals, and 31 rule types — DuckDB, Postgres, BigQuery, Databricks, Athena, Snowflake.

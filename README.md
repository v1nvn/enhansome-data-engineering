# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,988 | 🐛 87 | 📅 2026-03-09 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 39,902 | 🐛 5,891 | 🌐 Go | 📅 2026-03-30 - A distributed NewSQL database compatible with MySQL protocol.
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,391 | 🐛 76 | 🌐 Go | 📅 2026-03-29 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,360 | 🐛 2,128 | 🌐 Rust | 📅 2026-03-27 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 13,965 | 🐛 796 | 🌐 Java | 📅 2026-03-28 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  ...
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,626 | 🐛 1,621 | 🌐 Lua | 📅 2026-03-27 - An in-memory database and application server.
...
* Graph
  ...
  * [Actionbase](https://github.com/kakao/actionbase) ⭐ 212 | 🐛 20 | 🌐 Kotlin | 📅 2026-03-30 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,440 | 🐛 3,613 | 🌐 C++ | 📅 2026-03-30 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* [datacompy](https://github.com/capitalone/datacompy) ⭐ 638 | 🐛 10 | 🌐 Python | 📅 2026-03-29 - A Python library that facilitates the comparison of two DataFrames in Pandas, Polars, Spark and more. The library goes beyond basic equality checks by providing detailed insights into discrepancies at both row and column levels.
* [dvt](https://github.com/GoogleCloudPlatform/professional-services-data-validator) ⭐ 499 | 🐛 150 | 🌐 Python | 📅 2026-03-27 - Data Validation Tool compares data from source and target tables to ensure that they match. It provides column validation, row validation, schema validation, custom query validation, and ad hoc SQL exploration.
* [everyrow](https://github.com/futuresearch/everyrow-sdk) ⭐ 26 | 🐛 3 | 🌐 Python | 📅 2026-03-27 - AI-powered data operations SDK for Python. Semantic deduplication, fuzzy table merging, and intelligent row ranking using LLM agents.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 941 | 🐛 568 | 🌐 C | 📅 2026-03-28 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 264 | 🐛 273 | 🌐 Java | 📅 2026-03-30 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 7,166 | 🐛 36 | 🌐 Rust | 📅 2026-03-29 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,107 | 🐛 40 | 🌐 Python | 📅 2026-03-23 - Utility belt to handle data on AWS.
...
* [Gobblin](https://github.com/apache/incubator-gobblin) ⭐ 2,261 | 🐛 134 | 🌐 Java | 📅 2026-03-26 - Universal data ingestion framework for Hadoop from LinkedIn.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,370 | 🐛 171 | 🌐 Go | 📅 2026-03-30 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [S3QL](https://github.com/s3ql/s3ql/) ⭐ 1,231 | 🐛 15 | 🌐 Python | 📅 2026-03-29 - A file system that stores all its data online using storage services like Google Storage, Amazon S3, or OpenStack.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,019 | 🐛 247 | 🌐 C++ | 📅 2026-03-30 - Protocol Buffers - Google's data interchange format.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 63,107 | 🐛 31 | 🌐 Python | 📅 2026-03-29 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,664 | 🐛 63 | 🌐 Rust | 📅 2026-03-30 - An open source ETL framework to build fresh index for AI.
...
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,688 | 🐛 42 | 🌐 Go | 📅 2026-03-26 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 680 | 🐛 175 | 🌐 Java | 📅 2026-03-30 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 71,643 | 🐛 1,173 | 🌐 TypeScript | 📅 2026-03-29 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 46,665 | 🐛 4,038 | 🌐 Clojure | 📅 2026-03-30 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,493 | 🐛 599 | 🌐 Python | 📅 2026-03-27 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 44,820 | 🐛 1,816 | 🌐 Python | 📅 2026-03-30 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,615 | 🐛 515 | 🌐 Java | 📅 2026-03-27 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,160 | 🐛 2,799 | 🌐 Python | 📅 2026-03-27 - An open-source Python library for building data applications.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,380 | 🐛 29 | 🌐 Go | 📅 2026-03-29 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,442 | 🐛 149 | 🌐 Jupyter Notebook | 📅 2026-03-29 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,645 | 🐛 102 | 🌐 Ruby | 📅 2026-03-26 - The open-source reverse ETL, data activation platform for modern data teams.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,485 | 🐛 36 | 🌐 Go | 📅 2026-03-29 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [PACE](https://github.com/getstrm/pace) ⭐ 38 | 🐛 16 | 🌐 Kotlin | 📅 2026-03-29 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,222 | 🐛 440 | 🌐 Go | 📅 2026-03-29 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,930 | 🐛 836 | 🌐 Java | 📅 2026-03-30 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
...
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,366 | 🐛 1,659 | 🌐 Go | 📅 2026-03-28 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 63,306 | 🐛 766 | 🌐 Go | 📅 2026-03-27 - An open-source service monitoring system and time series database.
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 57 | 🐛 2 | 🌐 Python | 📅 2026-03-29 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.

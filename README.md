# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,671 | 🐛 62 | 📅 2026-04-02 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 39,964 | 🐛 5,985 | 🌐 Go | 📅 2026-04-13 - A distributed NewSQL database compatible with MySQL protocol.
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,416 | 🐛 77 | 🌐 Go | 📅 2026-04-09 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,435 | 🐛 2,140 | 🌐 Rust | 📅 2026-04-10 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 13,976 | 🐛 807 | 🌐 Java | 📅 2026-04-12 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  ...
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,622 | 🐛 1,634 | 🌐 Lua | 📅 2026-04-11 - An in-memory database and application server.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,467 | 🐛 3,619 | 🌐 C++ | 📅 2026-04-13 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* [everyrow](https://github.com/futuresearch/everyrow-sdk) ⭐ 30 | 🐛 3 | 🌐 Python | 📅 2026-04-08 - AI-powered data operations SDK for Python. Semantic deduplication, fuzzy table merging, and intelligent row ranking using LLM agents.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 950 | 🐛 563 | 🌐 C | 📅 2026-04-13 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 274 | 🐛 290 | 🌐 Java | 📅 2026-04-13 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 7,518 | 🐛 29 | 🌐 Rust | 📅 2026-04-12 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,105 | 🐛 39 | 🌐 Python | 📅 2026-04-11 - Utility belt to handle data on AWS.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,430 | 🐛 171 | 🌐 Go | 📅 2026-04-13 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,074 | 🐛 279 | 🌐 C++ | 📅 2026-04-12 - Protocol Buffers - Google's data interchange format.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 63,554 | 🐛 37 | 🌐 Python | 📅 2026-04-13 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,848 | 🐛 59 | 🌐 Rust | 📅 2026-04-13 - An open source ETL framework to build fresh index for AI.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 682 | 🐛 212 | 🌐 Java | 📅 2026-04-13 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 72,381 | 🐛 1,232 | 🌐 TypeScript | 📅 2026-04-12 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 46,828 | 🐛 4,091 | 🌐 Clojure | 📅 2026-04-13 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,197 | 🐛 547 | 🌐 Python | 📅 2026-04-11 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [QueryGPT](https://github.com/MKY508/QueryGPT) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2026-04-11 - Natural language database query interface with automatic chart generation, supporting Chinese and English queries.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 45,029 | 🐛 1,713 | 🌐 Python | 📅 2026-04-13 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,687 | 🐛 513 | 🌐 Java | 📅 2026-04-12 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,702 | 🐛 160 | 🌐 Python | 📅 2026-04-10 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,311 | 🐛 2,727 | 🌐 Python | 📅 2026-04-11 - An open-source Python library for building data applications.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,395 | 🐛 27 | 🌐 Go | 📅 2026-04-12 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,530 | 🐛 32 | 🌐 Go | 📅 2026-04-12 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,236 | 🐛 440 | 🌐 Go | 📅 2026-04-10 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,916 | 🐛 873 | 🌐 Java | 📅 2026-04-11 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,450 | 🐛 164 | 🌐 Java | 📅 2026-04-13 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,409 | 🐛 1,673 | 🌐 Go | 📅 2026-04-10 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [FirstData](https://github.com/MLT-OSS/FirstData) ⭐ 148 | 🐛 5 | 🌐 Python | 📅 2026-04-13 - The world's most comprehensive authoritative data source knowledge base. 160+ curated sources from governments, international organizations, and research institutions with MCP integration.

## Monitoring

### Prometheus

* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 63,555 | 🐛 759 | 🌐 Go | 📅 2026-04-10 - An open-source service monitoring system and time series database.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 472 | 🐛 83 | 🌐 C++ | 📅 2026-04-12 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 57 | 🐛 1 | 🌐 Python | 📅 2026-04-12 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.

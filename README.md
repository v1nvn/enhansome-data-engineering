# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,821 | 🐛 80 | 📅 2026-03-09 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 39,896 | 🐛 5,862 | 🌐 Go | 📅 2026-03-16 - A distributed NewSQL database compatible with MySQL protocol.
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,347 | 🐛 82 | 🌐 Go | 📅 2026-03-13 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,355 | 🐛 2,139 | 🌐 Rust | 📅 2026-03-12 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 13,962 | 🐛 794 | 🌐 Java | 📅 2026-03-16 - Column oriented distributed data store ideal for powering interactive applications.
  * [OpenTSDB](https://github.com/OpenTSDB/opentsdb) ⭐ 5,065 | 🐛 537 | 🌐 Java | 📅 2024-12-12 - A scalable, distributed Time Series Database.
  * [kairosdb](https://github.com/kairosdb/kairosdb) ⭐ 1,753 | 🐛 139 | 🌐 Java | 📅 2026-03-05 - Fast scalable time series database.
...
* Other
  ...
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,622 | 🐛 1,625 | 🌐 Lua | 📅 2026-03-13 - An in-memory database and application server.
...
* Graph
  ...
  * [Actionbase](https://github.com/kakao/actionbase) ⭐ 211 | 🐛 17 | 🌐 Kotlin | 📅 2026-03-13 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,408 | 🐛 3,623 | 🌐 C++ | 📅 2026-03-15 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
    * [CCM](https://github.com/pcmanus/ccm) ⭐ 1,234 | 🐛 68 | 🌐 Python | 📅 2025-12-30 - A script to easily create and destroy an Apache Cassandra cluster on localhost.
  ...
  * [FiloDB](https://github.com/filodb/FiloDB) ⭐ 1,460 | 🐛 62 | 🌐 Scala | 📅 2026-03-14 - Distributed. Columnar. Versioned. Streaming. SQL.
...
* [dvt](https://github.com/GoogleCloudPlatform/professional-services-data-validator) ⭐ 498 | 🐛 151 | 🌐 Python | 📅 2026-03-13 - Data Validation Tool compares data from source and target tables to ensure that they match. It provides column validation, row validation, schema validation, custom query validation, and ad hoc SQL exploration.
* [everyrow](https://github.com/futuresearch/everyrow-sdk) ⭐ 17 | 🐛 3 | 🌐 Python | 📅 2026-03-13 - AI-powered data operations SDK for Python. Semantic deduplication, fuzzy table merging, and intelligent row ranking using LLM agents.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 926 | 🐛 560 | 🌐 C | 📅 2026-03-13 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 503 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 260 | 🐛 269 | 🌐 Java | 📅 2026-03-16 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 6,711 | 🐛 31 | 🌐 Rust | 📅 2026-03-15 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,107 | 🐛 40 | 🌐 Python | 📅 2026-03-15 - Utility belt to handle data on AWS.
* [Heka](https://github.com/mozilla-services/heka) ⚠️ Archived - Data Acquisition and Processing Made Easy. Deprecated.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,425 | 🐛 20 | 🌐 Python | 📅 2026-03-15 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
* [Gobblin](https://github.com/apache/incubator-gobblin) ⭐ 2,261 | 🐛 134 | 🌐 Java | 📅 2026-03-11 - Universal data ingestion framework for Hadoop from LinkedIn.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,327 | 🐛 171 | 🌐 Go | 📅 2026-03-16 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 70,845 | 🐛 257 | 🌐 C++ | 📅 2026-03-16 - Protocol Buffers - Google's data interchange format.
...
* [Kryo](https://github.com/EsotericSoftware/kryo) ⭐ 6,497 | 🐛 38 | 🌐 HTML | 📅 2026-03-09 - A fast and efficient object graph serialization framework for Java.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,387 | 🐛 38 | 🌐 Python | 📅 2026-03-15 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,462 | 🐛 63 | 🌐 Rust | 📅 2026-03-16 - An open source ETL framework to build fresh index for AI.
...
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,683 | 🐛 45 | 🌐 Go | 📅 2026-03-11 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 682 | 🐛 173 | 🌐 Java | 📅 2026-03-15 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 70,975 | 🐛 1,133 | 🌐 TypeScript | 📅 2026-03-16 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 46,412 | 🐛 3,985 | 🌐 Clojure | 📅 2026-03-16 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,463 | 🐛 580 | 🌐 Python | 📅 2026-03-13 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 44,657 | 🐛 1,768 | 🌐 Python | 📅 2026-03-16 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,537 | 🐛 529 | 🌐 Java | 📅 2026-03-15 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,697 | 🐛 157 | 🌐 Python | 📅 2026-03-07 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,105 | 🐛 2,795 | 🌐 Python | 📅 2026-03-16 - An open-source Python library for building data applications.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,374 | 🐛 37 | 🌐 Go | 📅 2026-03-15 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,432 | 🐛 162 | 🌐 Jupyter Notebook | 📅 2026-03-16 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,643 | 🐛 103 | 🌐 Ruby | 📅 2026-03-13 - The open-source reverse ETL, data activation platform for modern data teams.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,454 | 🐛 26 | 🌐 Go | 📅 2026-03-15 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [PACE](https://github.com/getstrm/pace) ⭐ 38 | 🐛 16 | 🌐 Kotlin | 📅 2026-03-15 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,208 | 🐛 442 | 🌐 Go | 📅 2026-03-16 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,908 | 🐛 819 | 🌐 Java | 📅 2026-03-16 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,434 | 🐛 156 | 🌐 Java | 📅 2026-03-16 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,284 | 🐛 1,665 | 🌐 Go | 📅 2026-03-16 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 63,200 | 🐛 764 | 🌐 Go | 📅 2026-03-13 - An open-source service monitoring system and time series database.
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 57 | 🐛 2 | 🌐 Python | 📅 2026-03-16 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.

# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,984 | 🐛 59 | 📅 2026-04-02 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 39,945 | 🐛 5,989 | 🌐 Go | 📅 2026-04-10 - A distributed NewSQL database compatible with MySQL protocol.
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,414 | 🐛 77 | 🌐 Go | 📅 2026-04-09 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,421 | 🐛 2,140 | 🌐 Rust | 📅 2026-04-10 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 13,975 | 🐛 808 | 🌐 Java | 📅 2026-04-11 - Column oriented distributed data store ideal for powering interactive applications.
  * [OpenTSDB](https://github.com/OpenTSDB/opentsdb) ⭐ 5,063 | 🐛 537 | 🌐 Java | 📅 2024-12-12 - A scalable, distributed Time Series Database.
  * [kairosdb](https://github.com/kairosdb/kairosdb) ⭐ 1,757 | 🐛 141 | 🌐 Java | 📅 2026-03-05 - Fast scalable time series database.
  ...
  * [Timely](https://github.com/NationalSecurityAgency/timely) ⭐ 389 | 🐛 22 | 🌐 Java | 📅 2026-03-25 - A time series database application that provides secure access to time series data based on Accumulo and Grafana.
...
* Other
  * [cayley](https://github.com/cayleygraph/cayley) ⭐ 15,040 | 🐛 92 | 🌐 Go | 📅 2025-11-22 - An open-source graph database. Google.
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,622 | 🐛 1,633 | 🌐 Lua | 📅 2026-04-10 - An in-memory database and application server.
...
* Graph
  ...
  * [Actionbase](https://github.com/kakao/actionbase) ⭐ 213 | 🐛 19 | 🌐 Kotlin | 📅 2026-04-10 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,455 | 🐛 3,617 | 🌐 C++ | 📅 2026-04-10 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
    * [CCM](https://github.com/pcmanus/ccm) ⭐ 1,233 | 🐛 69 | 🌐 Python | 📅 2026-03-26 - A script to easily create and destroy an Apache Cassandra cluster on localhost.
  ...
  * [FiloDB](https://github.com/filodb/FiloDB) ⭐ 1,464 | 🐛 63 | 🌐 Scala | 📅 2026-04-09 - Distributed. Columnar. Versioned. Streaming. SQL.
...
* [datacompy](https://github.com/capitalone/datacompy) ⭐ 638 | 🐛 10 | 🌐 Python | 📅 2026-04-09 - A Python library that facilitates the comparison of two DataFrames in Pandas, Polars, Spark and more. The library goes beyond basic equality checks by providing detailed insights into discrepancies at both row and column levels.
* [dvt](https://github.com/GoogleCloudPlatform/professional-services-data-validator) ⭐ 497 | 🐛 150 | 🌐 Python | 📅 2026-04-10 - Data Validation Tool compares data from source and target tables to ensure that they match. It provides column validation, row validation, schema validation, custom query validation, and ad hoc SQL exploration.
* [everyrow](https://github.com/futuresearch/everyrow-sdk) ⭐ 29 | 🐛 3 | 🌐 Python | 📅 2026-04-08 - AI-powered data operations SDK for Python. Semantic deduplication, fuzzy table merging, and intelligent row ranking using LLM agents.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [kafka-docker](https://github.com/wurstmeister/kafka-docker) ⭐ 6,976 | 🐛 126 | 🌐 Shell | 📅 2024-05-08 - Kafka in Docker.
  * [kafkacat](https://github.com/edenhill/kafkacat) ⭐ 5,744 | 🐛 162 | 🌐 C | 📅 2024-07-09 - Generic command line non-JVM Apache Kafka producer and consumer.
  * [kafka-node](https://github.com/SOHU-Co/kafka-node) ⭐ 2,658 | 🐛 447 | 🌐 JavaScript | 📅 2023-08-30 - Node.js client for Apache Kafka 0.8.
  * [Secor](https://github.com/pinterest/secor) ⭐ 1,859 | 🐛 269 | 🌐 Java | 📅 2026-03-10 - Pinterest's Kafka to S3 distributed consumer.
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 948 | 🐛 563 | 🌐 C | 📅 2026-04-11 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 274 | 🐛 291 | 🌐 Java | 📅 2026-04-11 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 7,501 | 🐛 35 | 🌐 Rust | 📅 2026-04-11 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,105 | 🐛 38 | 🌐 Python | 📅 2026-04-10 - Utility belt to handle data on AWS.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,441 | 🐛 20 | 🌐 Python | 📅 2026-04-10 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
* [Heka](https://github.com/mozilla-services/heka) ⚠️ Archived - Data Acquisition and Processing Made Easy. Deprecated.
* [Gobblin](https://github.com/apache/incubator-gobblin) ⭐ 2,263 | 🐛 133 | 🌐 Java | 📅 2026-04-09 - Universal data ingestion framework for Hadoop from LinkedIn.
...
* [crdt-merge](https://github.com/mgillr/crdt-merge) ⭐ 0 | 🐛 4 | 🌐 Python | 📅 2026-04-10 - Conflict-free merge for DataFrames, JSON, ML models & distributed agents — powered by CRDTs.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,425 | 🐛 167 | 🌐 Go | 📅 2026-04-10 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
* [AWS S3](https://aws.amazon.com/s3/) - Object storage built to retrieve any amount of data from anywhere.
  * [smart\_open](https://github.com/RaRe-Technologies/smart_open) ⭐ 3,440 | 🐛 19 | 🌐 Python | 📅 2026-04-01 - Utils for streaming large files (S3, HDFS, gzip, bz2).
* [S3QL](https://github.com/s3ql/s3ql/) ⭐ 1,234 | 🐛 14 | 🌐 Python | 📅 2026-04-10 - A file system that stores all its data online using storage services like Google Storage, Amazon S3, or OpenStack.
...
* [SeaweedFS](https://github.com/chrislusf/seaweedfs) ⭐ 18 | 🐛 0 | 🌐 Go | 📅 2026-03-28 - Seaweed-FS is a simple and highly scalable distributed file system. There are two objectives: to store billions of files! to serve the files fast! Instead of supporting full POSIX file system semantics, Seaweed-FS choose to implement only a key\~file mapping. Similar to the word "NoSQL", you can call it as "NoFS".
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,060 | 🐛 257 | 🌐 C++ | 📅 2026-04-11 - Protocol Buffers - Google's data interchange format.
* [Apache Parquet](https://parquet.apache.org) - A columnar storage format available to any project in the Hadoop ecosystem, regardless of the choice of data processing framework, data model or programming language.
  * [Snappy](https://github.com/google/snappy) ⭐ 6,556 | 🐛 56 | 🌐 C++ | 📅 2026-03-06 - A fast compressor/decompressor. Used with Parquet.
  * [PigZ](https://zlib.net/pigz/) - A parallel implementation of gzip for modern multi-processor, multi-core machines.
* [Kryo](https://github.com/EsotericSoftware/kryo) ⭐ 6,507 | 🐛 39 | 🌐 HTML | 📅 2026-04-06 - A fast and efficient object graph serialization framework for Java.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 63,484 | 🐛 38 | 🌐 Python | 📅 2026-04-10 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,833 | 🐛 59 | 🌐 Rust | 📅 2026-04-11 - An open source ETL framework to build fresh index for AI.
* [PipelineDB](https://github.com/pipelinedb/pipelinedb) ⭐ 2,658 | 🐛 133 | 🌐 C | 📅 2022-02-20 - The Streaming SQL Database.
* [Robinhood's Faust](https://github.com/faust-streaming/faust) ⭐ 1,866 | 🐛 147 | 🌐 Python | 📅 2026-03-30 - Forever scalable event processing & in-memory durable K/V store as a library with asyncio & static typing.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,695 | 🐛 43 | 🌐 Go | 📅 2026-04-09 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 682 | 🐛 212 | 🌐 Java | 📅 2026-04-11 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* Batch SQL
  * [Hive](https://hive.apache.org) - Data warehouse software facilitates querying and managing large datasets residing in distributed storage.
    * [PyHive](https://github.com/dropbox/PyHive) ⭐ 1,696 | 🐛 222 | 🌐 Python | 📅 2024-08-07 - Python interface to Hive and Presto.
...
* [Substation](https://github.com/brexhq/substation) ⭐ 395 | 🐛 1 | 🌐 Go | 📅 2026-01-20 - A cloud native data pipeline and transformation toolkit written in Go.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 72,336 | 🐛 1,216 | 🌐 TypeScript | 📅 2026-04-10 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 46,823 | 🐛 4,082 | 🌐 Clojure | 📅 2026-04-11 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,190 | 🐛 546 | 🌐 Python | 📅 2026-04-10 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [QueryGPT](https://github.com/MKY508/QueryGPT) ⭐ 29 | 🐛 0 | 🌐 Python | 📅 2026-04-04 - Natural language database query interface with automatic chart generation, supporting Chinese and English queries.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 44,999 | 🐛 1,706 | 🌐 Python | 📅 2026-04-11 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,684 | 🐛 512 | 🌐 Java | 📅 2026-04-10 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,701 | 🐛 160 | 🌐 Python | 📅 2026-04-10 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,299 | 🐛 2,734 | 🌐 Python | 📅 2026-04-11 - An open-source Python library for building data applications.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,393 | 🐛 26 | 🌐 Go | 📅 2026-04-10 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,449 | 🐛 146 | 🌐 Jupyter Notebook | 📅 2026-04-08 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,650 | 🐛 109 | 🌐 Ruby | 📅 2026-04-09 - The open-source reverse ETL, data activation platform for modern data teams.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,529 | 🐛 32 | 🌐 Go | 📅 2026-04-10 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [PACE](https://github.com/getstrm/pace) ⭐ 38 | 🐛 16 | 🌐 Kotlin | 📅 2026-04-08 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,236 | 🐛 442 | 🌐 Go | 📅 2026-04-10 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,913 | 🐛 870 | 🌐 Java | 📅 2026-04-10 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,449 | 🐛 161 | 🌐 Java | 📅 2026-04-11 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,406 | 🐛 1,669 | 🌐 Go | 📅 2026-04-10 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
* [Weave](https://github.com/weaveworks/weave) ⚠️ Archived - Weaving Docker containers into applications.
* [Flocker](https://github.com/ClusterHQ/flocker) ⭐ 3,386 | 🐛 80 | 🌐 Python | 📅 2017-05-18 - Easily manage Docker containers & their data.
* [Gockerize](https://github.com/redbooth/gockerize) ⭐ 668 | 🐛 0 | 🌐 Shell | 📅 2018-03-02 - Package golang service into minimal Docker containers.
...
* [Eventsim](https://github.com/Interana/eventsim) ⭐ 536 | 🐛 5 | 🌐 Scala | 📅 2026-01-27 - Event data simulator. Generates a stream of pseudo-random events from a set of users, designed to simulate web traffic.
...
* [FirstData](https://github.com/MLT-OSS/FirstData) ⭐ 147 | 🐛 3 | 🌐 Python | 📅 2026-04-11 - The world's most comprehensive authoritative data source knowledge base. 160+ curated sources from governments, international organizations, and research institutions with MCP integration.

## Monitoring

### Prometheus

* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 63,530 | 🐛 759 | 🌐 Go | 📅 2026-04-10 - An open-source service monitoring system and time series database.
...
* [Data Profiler](https://github.com/capitalone/dataprofiler) ⭐ 1,552 | 🐛 79 | 🌐 Python | 📅 2026-04-07 - The DataProfiler is a Python library designed to make data analysis, monitoring, and sensitive data detection easy.
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 472 | 🐛 83 | 🌐 C++ | 📅 2026-04-10 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
...
* [DQOps](https://github.com/dqops/dqo) ⭐ 190 | 🐛 4 | 🌐 Java | 📅 2026-01-05 - An open-source data quality platform for the whole data platform lifecycle from profiling new data sources to applying full automation of data quality monitoring.
* [daffy](https://github.com/vertti/daffy/) ⭐ 57 | 🐛 2 | 🌐 Python | 📅 2026-04-11 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.
* [Snowflake Emulator](https://github.com/nnnkkk7/snowflake-emulator) ⭐ 33 | 🐛 3 | 🌐 Go | 📅 2026-01-19 - A Snowflake-compatible emulator for local development and testing.
* [Provero](https://github.com/provero-org/provero) ⭐ 11 | 🐛 29 | 🌐 Python | 📅 2026-04-11 - A vendor-neutral, declarative data quality engine. Define checks in YAML, run anywhere. Includes 16 built-in check types, SQL batch optimizer, anomaly detection, and data contracts.

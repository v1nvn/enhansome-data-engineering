# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,409 | 🐛 71 | 📅 2026-01-28 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 39,794 | 🐛 5,673 | 🌐 Go | 📅 2026-02-19 - A distributed NewSQL database compatible with MySQL protocol.
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,314 | 🐛 75 | 🌐 Go | 📅 2026-02-19 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,254 | 🐛 2,132 | 🌐 Rust | 📅 2026-02-19 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 13,938 | 🐛 777 | 🌐 Java | 📅 2026-02-19 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  ...
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,617 | 🐛 1,606 | 🌐 Lua | 📅 2026-02-18 - An in-memory database and application server.
...
* Graph
  ...
  * [Actionbase](https://github.com/kakao/actionbase) ⭐ 208 | 🐛 18 | 🌐 Kotlin | 📅 2026-02-15 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,350 | 🐛 3,652 | 🌐 C++ | 📅 2026-02-19 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
  ...
  * [FiloDB](https://github.com/filodb/FiloDB) ⭐ 1,464 | 🐛 61 | 🌐 Scala | 📅 2026-02-18 - Distributed. Columnar. Versioned. Streaming. SQL.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 914 | 🐛 554 | 🌐 C | 📅 2026-02-18 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 503 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 253 | 🐛 245 | 🌐 Java | 📅 2026-02-19 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 6,047 | 🐛 12 | 🌐 HTML | 📅 2026-02-18 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
...
* [Gobblin](https://github.com/apache/incubator-gobblin) ⭐ 2,260 | 🐛 137 | 🌐 Java | 📅 2026-02-18 - Universal data ingestion framework for Hadoop from LinkedIn.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,232 | 🐛 147 | 🌐 Go | 📅 2026-02-17 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 70,693 | 🐛 239 | 🌐 C++ | 📅 2026-02-19 - Protocol Buffers - Google's data interchange format.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 59,694 | 🐛 30 | 🌐 Python | 📅 2026-02-18 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 6,112 | 🐛 61 | 🌐 Rust | 📅 2026-02-19 - An open source ETL framework to build fresh index for AI.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 678 | 🐛 170 | 🌐 Java | 📅 2026-02-13 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 70,582 | 🐛 1,136 | 🌐 TypeScript | 📅 2026-02-19 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 45,989 | 🐛 3,989 | 🌐 Clojure | 📅 2026-02-19 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,497 | 🐛 561 | 🌐 Python | 📅 2026-02-18 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 44,316 | 🐛 1,746 | 🌐 Python | 📅 2026-02-19 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,413 | 🐛 533 | 🌐 Java | 📅 2026-02-18 - A versatile open source orchestrator and scheduler built on Java, designed to handle a broad range of workflows with a language-agnostic, API-first architecture.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,671 | 🐛 156 | 🌐 Python | 📅 2026-02-18 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 14,964 | 🐛 2,761 | 🌐 Python | 📅 2026-02-18 - An open-source Python library for building data applications.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,362 | 🐛 32 | 🌐 Go | 📅 2026-02-19 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
...
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,642 | 🐛 80 | 🌐 Ruby | 📅 2026-02-19 - The open-source reverse ETL, data activation platform for modern data teams.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,373 | 🐛 45 | 🌐 Go | 📅 2026-02-18 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, Postgres, Redshift, and more. Includes VS Code extension with live previews.
...
* [PACE](https://github.com/getstrm/pace) ⭐ 38 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-18 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,158 | 🐛 438 | 🌐 Go | 📅 2026-02-18 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,856 | 🐛 779 | 🌐 Java | 📅 2026-02-17 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,417 | 🐛 158 | 🌐 Java | 📅 2026-02-19 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 18,893 | 🐛 81 | 🌐 Go | 📅 2026-02-18 - Analyzes resource usage and performance characteristics of running containers.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,205 | 🐛 1,655 | 🌐 Go | 📅 2026-02-18 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 62,794 | 🐛 758 | 🌐 Go | 📅 2026-02-18 - An open-source service monitoring system and time series database.
...
* [DQOps](https://github.com/dqops/dqo) ⭐ 185 | 🐛 4 | 🌐 Java | 📅 2026-01-05 - An open-source data quality platform for the whole data platform lifecycle from profiling new data sources to applying full automation of data quality monitoring.
* [daffy](https://github.com/vertti/daffy/) ⭐ 53 | 🐛 4 | 🌐 Python | 📅 2026-02-18 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.

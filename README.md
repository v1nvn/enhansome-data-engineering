# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 467,880 | 🐛 76 | 📅 2026-05-05 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 40,102 | 🐛 6,243 | 🌐 Go | 📅 2026-05-19 - A distributed NewSQL database compatible with MySQL protocol.
  ...
  * [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,513 | 🐛 73 | 🌐 Go | 📅 2026-05-18 - Replicated SQLite using the Raft consensus protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,499 | 🐛 2,145 | 🌐 Rust | 📅 2026-05-18 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 13,994 | 🐛 811 | 🌐 Java | 📅 2026-05-19 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  ...
  * [Tarantool](https://github.com/tarantool/tarantool/) ⭐ 3,635 | 🐛 1,643 | 🌐 Lua | 📅 2026-05-18 - An in-memory database and application server.
  * [Snappydata](https://github.com/SnappyDataInc/snappydata) ⭐ 1,034 | 🐛 117 | 🌐 Scala | 📅 2022-11-21 - OLTP + OLAP Database built on Apache Spark.
  * [SlothDB](https://github.com/SouravRoy-ETL/slothdb) ⭐ 853 | 🐛 7 | 🌐 C++ | 📅 2026-05-18 - In-process analytical SQL database written in C++20. Reads Parquet, CSV, JSON, Avro, Arrow, SQLite, and Excel directly. Single binary, Python package, and 1.3 MB WASM build for the browser.
...
* Graph
  ...
  * [Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 223 | 🐛 10 | 🌐 Rust | 📅 2026-05-18 - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
  * [Actionbase](https://github.com/kakao/actionbase) ⭐ 215 | 🐛 24 | 🌐 Kotlin | 📅 2026-05-18 - A database for user interactions (likes, views, follows) represented as graphs, with precomputed reads served in real-time.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,548 | 🐛 3,554 | 🌐 C++ | 📅 2026-05-19 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
  ...
  * [FiloDB](https://github.com/filodb/FiloDB) ⭐ 1,464 | 🐛 65 | 🌐 Scala | 📅 2026-05-19 - Distributed. Columnar. Versioned. Streaming. SQL.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [kafkacat](https://github.com/edenhill/kafkacat) ⭐ 5,755 | 🐛 161 | 🌐 C | 📅 2024-07-09 - Generic command line non-JVM Apache Kafka producer and consumer.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 976 | 🐛 570 | 🌐 C | 📅 2026-05-18 - The Apache Kafka C/C++ library.
  * [kafkat](https://github.com/airbnb/kafkat) ⭐ 502 | 🐛 14 | 🌐 Ruby | 📅 2019-06-01 - Simplified command-line administration for Kafka brokers.
  * [Kroxylicious](https://github.com/kroxylicious/kroxylicious) ⭐ 283 | 🐛 291 | 🌐 Java | 📅 2026-05-19 - A Kafka Proxy, solving problems like encrypting your Kafka data at rest.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 8,339 | 🐛 38 | 🌐 Rust | 📅 2026-05-19 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
* [AWS Data Wrangler](https://github.com/awslabs/aws-data-wrangler) ⭐ 4,112 | 🐛 44 | 🌐 Python | 📅 2026-05-14 - Utility belt to handle data on AWS.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,467 | 🐛 25 | 🌐 Go | 📅 2026-05-11 - CLI tool to copy data between databases with a single command. Supports 50+ sources including PostgreSQL, MySQL, MongoDB, Salesforce, Shopify to any data warehouse.
* [Heka](https://github.com/mozilla-services/heka) ⚠️ Archived - Data Acquisition and Processing Made Easy. Deprecated.
* [Gobblin](https://github.com/apache/incubator-gobblin) ⭐ 2,265 | 🐛 137 | 🌐 Java | 📅 2026-05-15 - Universal data ingestion framework for Hadoop from LinkedIn.
...
* [drt](https://github.com/drt-hub/drt) ⭐ 25 | 🐛 81 | 🌐 Python | 📅 2026-05-19 - OSS Reverse ETL CLI. Sync data from warehouses to business tools via YAML.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,590 | 🐛 164 | 🌐 Go | 📅 2026-05-19 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
* [AWS S3](https://aws.amazon.com/s3/) - Object storage built to retrieve any amount of data from anywhere.
  * [smart\_open](https://github.com/RaRe-Technologies/smart_open) ⭐ 3,446 | 🐛 17 | 🌐 Python | 📅 2026-05-09 - Utils for streaming large files (S3, HDFS, gzip, bz2).
* [S3QL](https://github.com/s3ql/s3ql/) ⭐ 1,242 | 🐛 16 | 🌐 Python | 📅 2026-05-18 - A file system that stores all its data online using storage services like Google Storage, Amazon S3, or OpenStack.
...
* [SeaweedFS](https://github.com/chrislusf/seaweedfs) ⭐ 23 | 🐛 0 | 🌐 Go | 📅 2026-05-18 - Seaweed-FS is a simple and highly scalable distributed file system. There are two objectives: to store billions of files! to serve the files fast! Instead of supporting full POSIX file system semantics, Seaweed-FS choose to implement only a key\~file mapping. Similar to the word "NoSQL", you can call it as "NoFS".
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,242 | 🐛 276 | 🌐 C++ | 📅 2026-05-19 - Protocol Buffers - Google's data interchange format.
* [Apache Parquet](https://parquet.apache.org) - A columnar storage format available to any project in the Hadoop ecosystem, regardless of the choice of data processing framework, data model or programming language.
  * [Snappy](https://github.com/google/snappy) ⭐ 6,571 | 🐛 59 | 🌐 C++ | 📅 2026-05-09 - A fast compressor/decompressor. Used with Parquet.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 63,280 | 🐛 37 | 🌐 Python | 📅 2026-05-19 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 9,871 | 🐛 53 | 🌐 Python | 📅 2026-05-19 - An open source ETL framework to build fresh index for AI.
* [PipelineDB](https://github.com/pipelinedb/pipelinedb) ⭐ 2,661 | 🐛 133 | 🌐 C | 📅 2022-02-20 - The Streaming SQL Database.
* [Robinhood's Faust](https://github.com/faust-streaming/faust) ⭐ 1,872 | 🐛 147 | 🌐 Python | 📅 2026-03-30 - Forever scalable event processing & in-memory durable K/V store as a library with asyncio & static typing.
* [Kuiper](https://github.com/emqx/kuiper) ⭐ 1,701 | 🐛 45 | 🌐 Go | 📅 2026-05-15 - An edge lightweight IoT data analytics/streaming software implemented by Golang, and it can be run at all kinds of resource-constrained edge devices.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 688 | 🐛 205 | 🌐 Java | 📅 2026-05-19 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 72,906 | 🐛 1,229 | 🌐 TypeScript | 📅 2026-05-19 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 47,367 | 🐛 4,159 | 🌐 Clojure | 📅 2026-05-19 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,199 | 🐛 555 | 🌐 Python | 📅 2026-05-19 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 45,462 | 🐛 1,722 | 🌐 Python | 📅 2026-05-19 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,882 | 🐛 550 | 🌐 Java | 📅 2026-05-19 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
* [Luigi](https://github.com/spotify/luigi) ⭐ 18,721 | 🐛 158 | 🌐 Python | 📅 2026-05-12 - A Python module that helps you build complex pipelines of batch jobs.
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,534 | 🐛 2,660 | 🌐 Python | 📅 2026-05-19 - An open-source Python library for building data applications.
* [RudderStack](https://github.com/rudderlabs/rudder-server) ⭐ 4,408 | 🐛 35 | 🌐 Go | 📅 2026-05-19 - A warehouse-first Customer Data Platform that enables you to collect data from every application, website and SaaS platform, and then activate it in your warehouse and business tools.
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,489 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2026-05-18 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
* [Multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,655 | 🐛 127 | 🌐 Ruby | 📅 2026-05-19 - The open-source reverse ETL, data activation platform for modern data teams.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,593 | 🐛 26 | 🌐 Go | 📅 2026-05-18 - End-to-end data pipeline tool that combines ingestion, transformation (SQL + Python), and data quality in a single CLI. Connects to BigQuery, Snowflake, PostgreSQL, Redshift, and more. Includes VS Code extension with live previews.
...
* [PACE](https://github.com/getstrm/pace) ⭐ 39 | 🐛 16 | 🌐 Kotlin | 📅 2026-05-18 - An open source framework that allows you to enforce agreements on how data should be accessed, used, and transformed, regardless of the data platform (Snowflake, BigQuery, DataBricks, etc.)
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,375 | 🐛 434 | 🌐 Go | 📅 2026-05-18 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,953 | 🐛 915 | 🌐 Java | 📅 2026-05-18 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,459 | 🐛 165 | 🌐 Java | 📅 2026-05-13 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,133 | 🐛 63 | 🌐 Go | 📅 2026-05-14 - Analyzes resource usage and performance characteristics of running containers.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,510 | 🐛 1,671 | 🌐 Go | 📅 2026-05-18 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 64,088 | 🐛 774 | 🌐 Go | 📅 2026-05-18 - An open-source service monitoring system and time series database.
...
* [Data Profiler](https://github.com/capitalone/dataprofiler) ⭐ 1,554 | 🐛 79 | 🌐 Python | 📅 2026-05-06 - The DataProfiler is a Python library designed to make data analysis, monitoring, and sensitive data detection easy.
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 478 | 🐛 94 | 🌐 C++ | 📅 2026-05-13 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.
...
* [daffy](https://github.com/vertti/daffy/) ⭐ 58 | 🐛 2 | 🌐 Python | 📅 2026-05-19 - Decorator-first DataFrame contracts/validation (columns/dtypes/constraints) at function boundaries. Supports Pandas/Polars/PyArrow/Modin.

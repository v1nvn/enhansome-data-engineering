# Awesome Data Engineering [![Awesome](https://awesome.re/badge-flat2.svg)](https://github.com/sindresorhus/awesome) ⭐ 467,157 | 🐛 76 | 📅 2026-05-05 with stars
...
* Relational
  * [MySQL](https://www.mysql.com/) - The world's most popular open source database.
    * [TiDB](https://github.com/pingcap/tidb) ⭐ 40,096 | 🐛 6,233 | 🌐 Go | 📅 2026-05-16 - A distributed NewSQL database compatible with MySQL protocol.
...
* Timeseries
  * [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,502 | 🐛 2,144 | 🌐 Rust | 📅 2026-05-15 - Scalable datastore for metrics, events, and real-time analytics.
  * [Druid](https://github.com/apache/incubator-druid) ⭐ 13,993 | 🐛 822 | 🌐 Java | 📅 2026-05-17 - Column oriented distributed data store ideal for powering interactive applications.
...
* Other
  ...
  * [SlothDB](https://github.com/SouravRoy-ETL/slothdb) ⭐ 851 | 🐛 6 | 🌐 C++ | 📅 2026-05-16 - In-process analytical SQL database written in C++20. Reads Parquet, CSV, JSON, Avro, Arrow, SQLite, and Excel directly. Single binary, Python package, and 1.3 MB WASM build for the browser.
...
* Graph
  ...
  * [Omnigraph](https://github.com/ModernRelay/omnigraph) ⭐ 216 | 🐛 10 | 🌐 Rust | 📅 2026-05-17 - Typed graph database where agents branch and merge like Git. S3-native, Rust, traversal + vector + BM25 in one runtime.
...
* Column
  * [Cassandra](https://cassandra.apache.org/) - The right choice when you need scalability and high availability without compromising performance.
    * [ScyllaDB](https://github.com/scylladb/scylla) ⭐ 15,546 | 🐛 3,564 | 🌐 C++ | 📅 2026-05-17 - NoSQL data store using the seastar framework, compatible with Apache Cassandra.
...
* [Kafka](https://kafka.apache.org/) - Publish-subscribe messaging rethought as a distributed commit log.
  ...
  * [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 974 | 🐛 563 | 🌐 C | 📅 2026-05-17 - The Apache Kafka C/C++ library.
...
* [Kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) ⭐ 8,321 | 🐛 31 | 🌐 Rust | 📅 2026-05-17 - Polyglot document intelligence library with a Rust core and bindings for Python, TypeScript, Go, and more. Extracts text, tables, and metadata from 62+ document formats for data pipeline ingestion.
...
* [drt](https://github.com/drt-hub/drt) ⭐ 25 | 🐛 90 | 🌐 Python | 📅 2026-05-17 - OSS Reverse ETL CLI. Sync data from warehouses to business tools via YAML.
...
* [JuiceFS](https://github.com/juicedata/juicefs) ⭐ 13,585 | 🐛 168 | 🌐 Go | 📅 2026-05-15 - A high-performance Cloud-Native file system driven by object storage for large-scale data storage.
...
* [S3QL](https://github.com/s3ql/s3ql/) ⭐ 1,242 | 🐛 17 | 🌐 Python | 📅 2026-05-16 - A file system that stores all its data online using storage services like Google Storage, Amazon S3, or OpenStack.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,236 | 🐛 271 | 🌐 C++ | 📅 2026-05-16 - Protocol Buffers - Google's data interchange format.
* [Apache Parquet](https://parquet.apache.org) - A columnar storage format available to any project in the Hadoop ecosystem, regardless of the choice of data processing framework, data model or programming language.
  * [Snappy](https://github.com/google/snappy) ⭐ 6,570 | 🐛 59 | 🌐 C++ | 📅 2026-05-09 - A fast compressor/decompressor. Used with Parquet.
...
* [Pathway](https://github.com/pathwaycom/pathway) ⭐ 63,304 | 🐛 38 | 🌐 Python | 📅 2026-05-17 - Performant open-source Python ETL framework with Rust runtime, supporting 300+ data sources.
* [CocoIndex](https://github.com/cocoindex-io/cocoindex) ⭐ 9,807 | 🐛 55 | 🌐 Python | 📅 2026-05-17 - An open source ETL framework to build fresh index for AI.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 688 | 🐛 201 | 🌐 Java | 📅 2026-05-17 - - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT, and the native Kafka protocol.
...
* [Apache Superset](https://github.com/apache/incubator-superset) ⭐ 72,867 | 🐛 1,265 | 🌐 TypeScript | 📅 2026-05-16 - A modern, enterprise-ready business intelligence web application.
* [Metabase](https://github.com/metabase/metabase) ⭐ 47,346 | 🐛 4,135 | 🌐 Clojure | 📅 2026-05-16 - The easy, open source way for everyone in your company to ask questions and learn from data.
* [Plotly](https://github.com/plotly/dash) ⭐ 24,191 | 🐛 555 | 🌐 Python | 📅 2026-05-15 - Flask, JS, and CSS boilerplate for interactive, web-based visualization apps in Python.
...
* [Airflow](https://github.com/apache/airflow) ⭐ 45,441 | 🐛 1,744 | 🌐 Python | 📅 2026-05-16 - A system to programmatically author, schedule, and monitor data pipelines.
* [Kestra](https://github.com/kestra-io/kestra) ⭐ 26,871 | 🐛 535 | 🌐 Java | 📅 2026-05-15 - Scalable, event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,524 | 🐛 2,656 | 🌐 Python | 📅 2026-05-15 - An open-source Python library for building data applications.
...
* [Hamilton](https://github.com/dagworks-inc/hamilton) ⭐ 2,487 | 🐛 141 | 🌐 Jupyter Notebook | 📅 2026-05-16 - A lightweight library to define data transformations as a directed-acyclic graph (DAG). If you like dbt for SQL transforms, you will like Hamilton for Python processing.
...
* [lakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,373 | 🐛 436 | 🌐 Go | 📅 2026-05-16 - An open source platform that delivers resilience and manageability to object-storage based data lakes.
* [Gravitino](https://github.com/apache/gravitino) ⭐ 2,949 | 🐛 914 | 🌐 Java | 📅 2026-05-15 - An open-source, unified metadata management for data lakes, data warehouses, and external catalogs.
* [Project Nessie](https://github.com/projectnessie/nessie) ⭐ 1,458 | 🐛 164 | 🌐 Java | 📅 2026-05-13 - A Transactional Catalog for Data Lakes with Git-like semantics. Works with Apache Iceberg tables.
...
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,506 | 🐛 1,676 | 🌐 Go | 📅 2026-05-15 - A cluster manager, designed for both long-lived services and short-lived batch processing workloads.
...
* [Prometheus.io](https://github.com/prometheus/prometheus) ⭐ 64,074 | 🐛 772 | 🌐 Go | 📅 2026-05-15 - An open-source service monitoring system and time series database.
